...
//   Ising model of cubic lattice

int main ()
{ Ran  ran(31); //initializing random number, pick any integer of you choice
  
  ofstream myfile;
  myfile.open("cube.dat");
  for ( double T=0.2; T<3.2; T=T+0.1 ) {

    int dim=15;     // specifying the dimension of the array
